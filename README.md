...
3. *(Optional)* Click **Choose game folder** and pick your
   `Europa Universalis V` install folder. Coats of arms and the map are drawn
   from the game's own files, which are read locally and never redistributed.
